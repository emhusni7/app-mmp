...
export default function IForm(props){
    ...
    >{({
        ...
        <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
                <TextField variant="standard" value={values.item_name} onChange={handleChange} size="small" name="item_name" id="item_name" fullWidth placeholder="Item Name" required />
            </Grid>
            <Grid xs={6}></Grid>
            <Grid item xs={6}>
                <TextField variant="standard" value={values.description} onChange={handleChange} size="small" name="description" id="description" fullWidth  multiline
                rows={4}
